...
// Mode 4, Extremely aggressive.
static const int16_t kOverHangMax1EXG[3] = { 4, 2, 1 };
static const int16_t kOverHangMax2EXG[3] = { 7, 3, 2 };
static const int16_t kLocalThresholdEXG[3] = { 97, 96, 97 };
static const int16_t kGlobalThresholdEXG[3] = { 1100, 1050, 1100 };
...
int WebRtcVad_set_mode_core(VadInstT* self, int mode) {
  ...
  switch (mode) {
    ...
    case 4:
      // Very aggressive mode.
      memcpy(self->over_hang_max_1, kOverHangMax1EXG,
             sizeof(self->over_hang_max_1));
      memcpy(self->over_hang_max_2, kOverHangMax2EXG,
             sizeof(self->over_hang_max_2));
      memcpy(self->individual, kLocalThresholdEXG,
             sizeof(self->individual));
      memcpy(self->total, kGlobalThresholdEXG,
             sizeof(self->total));
      break;
